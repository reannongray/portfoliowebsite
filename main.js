// ========================================
// PARTICLE SYSTEM - Keep existing functionality
// ========================================
...
// ========================================
// SKILLS DATA - Keep existing data
// ========================================
const skills = {
  frontend: {
...
class ProjectCarousel {
  ...
  generateIndicators() {
    ...
    const totalIndicators = Math.ceil(this.totalItems / this.itemsToShow);
  ...
  updateCarousel() {
    ...
    indicatorElements.forEach((indicator, index) => {
      const slideIndex = Math.floor(this.currentIndex / this.itemsToShow);
  ...
  moveCarousel(direction) {
    const maxIndex = this.totalItems - this.itemsToShow;
  ...
  goToSlide(slideIndex) {
    this.currentIndex = slideIndex * this.itemsToShow;
    if (this.currentIndex >= this.totalItems) {
      this.currentIndex = this.totalItems - this.itemsToShow;
    }
    this.updateCarousel();
    this.updateNavButtons();
  }
...
// Initialize scrollable cards - Keep existing function
...
// ========================================
// MAIN INITIALIZATION - Updated to include carousel
// ========================================

// Wait for DOM content to be loaded
document.addEventListener('DOMContentLoaded', async function() {
  // Initialize Particle System (keep this!)
  ...
  // Initialize NEW carousel functionality
